...
void loop() {
  ...
  if (Serial.available() > 0) {
    ...
    if (val == 2) {
      ...
      s = 40;
      e = 50;
      Braccio.ServoMovement(3000, 113, s, e, 90, syaringan_kakashi - 12, grip);
      delay(delay_num);
      //手に押す
      s = 24;
      e = 36;
      Braccio.ServoMovement(3000, 111, s, e, 90, syaringan_kakashi - 12, grip);
      delay(delay_num);
      s = 24;
      e = 32;
      Braccio.ServoMovement(3000, 111, s, e, 95, syaringan_kakashi - 12, grip);
      delay(delay_num);
      s = 26;
      e = 29;
      Braccio.ServoMovement(3000, 111, s, e, 100, syaringan_kakashi - 12, grip);
      delay(delay_num);
      s = 27;
      e = 25;
      Braccio.ServoMovement(3000, 111, s, e, 103, syaringan_kakashi - 12, grip);
      delay(delay_num);
      //ここまで判子
      s = 50;
      e = 90;
      Braccio.ServoMovement(3000, 111, s, e, 120, syaringan_kakashi - 12, grip);
      delay(delay_num);
      //最後腕を振り上げる
...
//      delay(delay_num);
    ...
    if (val == 4) {
      ...
      s = 37;
      e = 37;
      Braccio.ServoMovement(3000, 106, s, e, 95, syaringan_sasuke + 3, grip);
      delay(delay_num);
      //判子を手に押す
      s = 29;
      e = 32;
      ...
      s = 31;
      e = 30;
      Braccio.ServoMovement(3000, 106, s, e, 100, syaringan_sasuke + 3, grip);
      delay(delay_num);
      s = 32;
      e = 25;
      Braccio.ServoMovement(3000, 106, s, e, 103, syaringan_sasuke + 3, grip);
      delay(delay_num);
      //ここまで判子
      s = 50;
      e = 90;
      Braccio.ServoMovement(3000, 106, s, e, 118, syaringan_sasuke, grip);
      delay(delay_num);
      //最後腕を振り上げる
      Braccio.ServoMovement(3000, 90, s, 90, 133, 90, grip);
      delay(delay_num);
    ...
    if (val == 6) {
      ...
      s = 50;
      e = 30;
      Braccio.ServoMovement(3000, 112, s, e, 95, ayanami, grip);
      delay(delay_num);
      //判子を手に押す
      s = 44;
      e = 20;
      ...
      s = 39;
      e = 23;
      Braccio.ServoMovement(3000, 112, s, e, 100, ayanami, grip);
      delay(delay_num);
      s = 36;
      e = 27;
      Braccio.ServoMovement(3000, 112, s, e, 105, ayanami, grip);
      delay(delay_num);
      //ここまで
      s = 50;
      e = 90;
      Braccio.ServoMovement(3000, 112, s, e, 133, ayanami, grip);
      delay(delay_num);
      //最後腕を振り上げる
      Braccio.ServoMovement(3000, 90, s, 90, 133, 90, grip);
      delay(delay_num);
    ...
    if (val == 7) {
      ...
      s = 51;
      e = 9;
      Braccio.ServoMovement(3000, 108, s, e, 125, pen, grip);
      delay(delay_num);
      s = 55;
      e = 7;
      Braccio.ServoMovement(3000, 108, s, e, 125, pen, grip);
    ...
    if (val == 8) {
      ...
      s = 50;
      e = 0;
      Braccio.ServoMovement(3000, 6, s, e, 130, golgo, grip);
      delay(delay_num);
      s = 43;
      e = 1;
      Braccio.ServoMovement(3000, 6, s, e, 134, golgo, grip);
      delay(delay_num);
      s = 40;
      e = 3;
      ...
      s = 37;
      e = 5;
      Braccio.ServoMovement(3000, 6, s, e, 142, golgo, grip);
      delay(delay_num);
      e = 90;
      Braccio.ServoMovement(3000, 6, s, e, 142, golgo, grip);
      delay(delay_num);
      ...
      s = 57;
      e = 37;
      Braccio.ServoMovement(3000, 109, s, e, 105, golgo, grip);
      delay(delay_num);
      //判子を手に押す
      s = 37;
      e = 17;
      Braccio.ServoMovement(3000, 109, s, e, 88, golgo, grip);
      delay(delay_num);
      s = 34;
      e = 20;
      Braccio.ServoMovement(3000, 109, s, e, 96, golgo, grip);
      delay(delay_num);
      s = 31;
      e = 23;
      Braccio.ServoMovement(3000, 109, s, e, 104, golgo, grip);
      delay(delay_num);
      s = 27;
      e = 29;
      Braccio.ServoMovement(3000, 109, s, e, 110, golgo, grip);
      delay(delay_num);
      s = 24;
      e = 32;
      Braccio.ServoMovement(3000, 109, s, e, 115, golgo, grip);
      delay(delay_num);
      //ここまで
      s = 50;
      e = 90;
    ...
    if (val == 9) {
      ...
      s = 45;
      e = 20;
      Braccio.ServoMovement(3000, 115, s, e, 90, pen, grip);
      delay(delay_num);
      s = 48;
      e = 16;
      ...
      s = 60;
      e = 70;
      Braccio.ServoMovement(3000, 119, s, e, 90, pen, grip);
      delay(delay_num);
      s = 70;
      e = 90;
      Braccio.ServoMovement(3000, 119, s, e, 90, pen, grip);

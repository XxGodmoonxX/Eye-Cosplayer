...
extern int step_shoulder = initial_shoulder;
extern int step_elbow = initial_elbow;
extern int step_wrist_ver = initial_wrist_ver;
extern int step_wrist_rot = initial_wrist_rot;
extern int step_gripper = initial_gripper;
...
unsigned int _Braccio::begin(int soft_start_level) {
  ...
  base.write(initial_base);
  shoulder.write(initial_shoulder);
  elbow.write(initial_elbow);
  wrist_ver.write(initial_wrist_ver);
  wrist_rot.write(initial_wrist_rot);
  gripper.write(initial_gripper);
  //Previous step motor position
  step_base = initial_base;
  step_shoulder = initial_shoulder;
  step_elbow = initial_elbow;
  step_wrist_ver = initial_wrist_ver;
  step_wrist_rot = initial_wrist_rot;
  step_gripper = initial_gripper;
